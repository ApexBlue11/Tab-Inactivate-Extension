...
$extensionName = 'Tab Inactivate'
$repoUrl = 'https://github.com/ApexBlue11/Tab-Inactivate-Extension'
$zipUrl = "$repoUrl/archive/refs/heads/main.zip"
$archiveRootName = 'Tab-Inactivate-Extension-main'
...
try {
  ...
  if ($usingLocalSource) {
    ...
    $tempRoot = Join-Path $env:TEMP ('tab-inactivate-install-' + [guid]::NewGuid().ToString('N'))
